...
// Componente para exibir um spinner de progresso comum
@Composable
...
// Componente para exibir uma notificação na tela
@Composable
...
// Componente para verificar se o usuário já fez login e redirecioná-lo para o perfil
@Composable
...
// Componente para exibir um divisor comum
@Composable
fun CommonDivider() {
    Divider(
...
// Componente para exibir uma imagem comum
@Composable
fun CommonImage(
    data: String?,
